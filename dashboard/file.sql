...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 21, 2025 at 09:41 AM
...
(6, 'b97365f8-7d8b-11f0-88e7-a497b18c6f38', 'Attendance Sheet', 'dashboard/Files/Attendance Sheet.pdf', '2025-08-21 07:35:53', 1, 1),
(7, 'b973781e-7d8b-11f0-88e7-a497b18c6f38', 'HR_Policy', '/dashboard/Files/HR_Policy.pdf', '2025-08-21 07:36:33', 1, 1);
...
INSERT INTO `users` (`id`, `email`, `password`, `created_at`, `role_id`) VALUES
('3700131d-7d8e-11f0-88e7-a497b18c6f38', 'ali1@gmail.com', '$2y$10$S9Z47NofWY0Q/HJ/tMWOeeES9I/3W1qkJ9QytSVEI9LxFq/Je0tgS', '2025-08-20 06:23:42', 2),
('b97365f8-7d8b-11f0-88e7-a497b18c6f38', 'ali@example.com', '$2y$10$S9Z47NofWY0Q/HJ/tMWOeeES9I/3W1qkJ9QytSVEI9LxFq/Je0tgS', '2025-08-20 06:05:52', 1),
('b9737786-7d8b-11f0-88e7-a497b18c6f38', 'bob@example.com', '$2y$10$S9Z47NofWY0Q/HJ/tMWOeeES9I/3W1qkJ9QytSVEI9LxFq/Je0tgS', '2025-08-20 06:05:52', 2),
('b973781e-7d8b-11f0-88e7-a497b18c6f38', 'car@example.com', '$2y$10$S9Z47NofWY0Q/HJ/tMWOeeES9I/3W1qkJ9QytSVEI9LxFq/Je0tgS', '2025-08-20 06:05:52', 2);
...
--
ALTER TABLE `file_permissions`
  ADD CONSTRAINT `file_permissions_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
